# dextinity-ingress-chart

Helm chart for Ingresses on Dextinity Microservices.
...
```bash
helm install my-release oci://ghcr.io/vivid-planet/charts/dextinity-ingress --version 1.0.0
```
...
This chart continues `comet-ingress` 1.3.1 from
